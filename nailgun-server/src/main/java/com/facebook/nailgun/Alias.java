 ...
 * commands more convenient. For example, an Alias can map the "<code>mycommand</code>" command to
 * the <code>com.yourdomain.yourpackage.YourClass</code> class. Obviously, it's a lot easier to type
 * "<code>ng mycommand</code>" than the fully qualified class name.
 *
...
public class Alias implements Comparable {
  ...
  /**
   * Returns the <code>Class</code> object providing a static <code>main()</code> or <code>
   * nailMain()</code> method for this command.
   *
   * @return the <code>Class</code> object providing a static <code>main()</code> or <code>
   *     nailMain()</code> method for this command.
   */
  ...
  /**
   * Checks whether two Aliases have the same name. Does <b>not</b> compare any other fields.
   *
