 ...
 * href="Alias.html">Alias</a> for more details.
 *
...
public class AliasManager {
  ...
  /**
   * Returns a Set that is a snapshot of the Alias list. Modifications to this Set will not impact
   * the AliasManager in any way.
   *
  ...
  /**
   * Removes the Alias with the specified name from the AliasManager. If no such Alias exists in
   * this AliasManager, this method has no effect.
   *
   ...
   * @return the requested Alias, or null if no such Alias is defined in this AliasManager.
   */
