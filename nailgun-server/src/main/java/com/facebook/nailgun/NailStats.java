...
public class NailStats implements Cloneable {
  ...
  /**
   * Returns the number of times this nail has been run. Nails that have started but not yet
   * finished are included in this number.
   *
  ...
  /**
   * Returns true iff the specified <code>NailStats</code> object is tracking the same class.
   *
  ...
  /**
   * Returns a String representation of this <code>NailStats</code> object, in the form "classname:
