...
public class AliasManager {
    ...
    public AliasManager() {
        ...
        try (InputStream is = cl.getResourceAsStream("com/martiansoftware/nailgun/builtins/builtins.properties")) {
            props.load(is);
     ...
     * <pre><code>[alias name]=[fully qualified classname]</code></pre> each of
     * which may have an optional
     * <pre><code>[alias name].desc=[alias description]</code></pre>
     *
     * For example, to create an alias called "
     * <code>myprog</code>" for class
     * <code>com.mydomain.myapp.MyProg</code>, the following properties would be
     * defined:
     *
